...
const LoginScreen = ({ navigation }: any) => {
  ...
  const authCredential = useSelector((state: any) => state?.appState?.authCredential);
              ...
              <View style={{ alignItems: 'center', marginVertical: 16 }}>
                {isDark ? (
                  ...
                  <Image
                    ...
                    style={{ width: windowWidth * 0.9, height: windowHeight * 0.1, resizeMode: 'contain', }}
                  />
                )}
              </View>
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center', marginVertical: 16 }}>
                <View style={{ position: 'absolute', }}>
                  <Checkbox
                    ...
                    onPress={() => { setIsCredential(!iscredential); }}
