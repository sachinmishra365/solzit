...
const AddToDo = ({ navigation }: any) => {
    ...
    const validationSchema = Yup.object().shape({
        ...
        estimatedEffort: Yup.number().required('Estimated Effort is required'),
                        ...
                        return (
                            <>
                                ...
                                {touched.projectName && errors.projectName && (
                                    <Text style={styles(isDark).errortxt}>{errors.projectName}</Text>
                                )}
                                <Menu
                                ...
                                {touched.userStory && errors.userStory && (
                                    <Text style={styles(isDark).errortxt}>{errors.userStory}</Text>
                                )}
                                ...
                                {touched.workStatus && errors.workStatus && (
                                    <Text style={styles(isDark).errortxt}>{errors.workStatus}</Text>
                                )}
                                <CustomTextInput
                                    label="Title"
                                    value={values.title}
                                ...
                                {touched.title && errors.title && (
                                    <Text style={styles(isDark).errortxt}>{errors.title}</Text>
                                )}
                                <CustomTextInput
                                ...
                                {touched.itemDescription && errors.itemDescription && (
                                    <Text style={styles(isDark).errortxt}>{errors.itemDescription}</Text>
                                )}
                                <CustomTextInput
                                ...
                                />
                                {touched.estimatedEffort && errors.estimatedEffort && (
                                    <Text style={styles(isDark).errortxt}>{errors.estimatedEffort}</Text>
                                )}
                                <Menu
                                ...
                                {touched.priority && errors.priority && (
                                    <Text style={styles(isDark).errortxt}>{errors.priority}</Text>
                                )}
                                <Menu
                                ...
                                {touched.assignee && errors.assignee && (
                                    <Text style={styles(isDark).errortxt}>{errors.assignee}</Text>
                                )}
                                <CustomTextInput
                                    ...
                                    numberOfLines={3}
                                />
                                {touched.plannedStartDate && errors.plannedStartDate && (
                                    <Text style={styles(isDark).errortxt}>{errors.plannedStartDate}</Text>
                                )}
                                <CustomTextInput
                                    ...
                                    multiline={true}
                                />
                                {touched.plannedEndDate && errors.plannedEndDate && (
                                    <Text style={styles(isDark).errortxt}>{errors.plannedEndDate}</Text>
                                )}
